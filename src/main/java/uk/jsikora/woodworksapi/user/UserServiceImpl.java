...
/** Implementation of UserService for user operations and OAuth registration. */
@Service
public class UserServiceImpl implements UserService {
    ...
    /** Creates new user if doesn't exist for given email and provider. */
    @Override
    ...
    /** Decrements project count only if current count > 0. */
    @Override
