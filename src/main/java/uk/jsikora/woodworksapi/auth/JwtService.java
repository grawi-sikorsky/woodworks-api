...
public class JwtService {
    ...
    /** Generates JWT token with user data and custom claims. */
    ...
    /** Extracts authentication provider from token. */
    ...
    /** Validates token against specific user - checks email match and expiration. */
