...
public class DoorsCabinGenerator implements CabinCuttingStrategy {
    ...
    public List<Item> generateItems(WorkRequest.CabinRequest cabinRequest) {
        ...
        items.add(new Item("Półka", innerWidth - 2, depth - 20, thickness, 1, PLYTA_MEBLOWA));
        ...
        if (doorCount == 2) {
            ...
            items.add(new Item("Front (lewy)", singleDoorWidth, frontHeight, thickness, 1, PLYTA_MEBLOWA));
            items.add(new Item("Front (prawy)", singleDoorWidth, frontHeight, thickness, 1, PLYTA_MEBLOWA));
        } else {
            items.add(new Item("Front", width - FRONT_CLEARANCE, frontHeight, thickness, 1, PLYTA_MEBLOWA));
        }
